"use client"
import { createTranscation, updateTransaction } from '@/actions/transcation'
...
const AddTranscationForm = ({accounts,categories,editMode=false,intialdata=null}) => {
...
const{register,setValue,handleSubmit,formState:{errors},watch,getValues,reset} =     useForm({
     ...
     } = useFetch( editMode ? updateTransaction :createTranscation);
     ...
     useEffect(()=>{
        if(transactionResult?.success && !transactionLoading){
            toast.success( editMode ? "Transcation updated succesfully":"Transaction Created successfully");
            reset();
    ...
    errors.date && (
        ...
        <div className='flex items-center justify-between rounded-lg border p-3'>
          <div className='space-y-0.5'>
              <label className='text-sm font-medium cursor-pointer' htmlFor="balance">Recuuring Transcation</label>
